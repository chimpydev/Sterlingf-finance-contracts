...
contract MinterTest is BaseTest {
    ...
    function deployBase() public {
        ...
        router.addLiquidity(address(FRAX), address(STERLING), false, TOKEN_1, TOKEN_1, 0, 0, address(owner), block.timestamp);
    ...
    function initializeVotingEscrow() public {
        ...
        assertEq(STERLING.balanceOf(address(minter)), 19 * TOKEN_1M);
    }
    ...
    function testMinterWeeklyDistribute() public {
        ...
        console2.log(STERLING.totalSupply());
