...
import "./BaseTest.sol";
import "contracts/SterlingGovernor.sol";

contract SterlingGovernorTest is BaseTest {
    VotingEscrow escrow;
    ...
    function setUp() public {
        ...
        STERLING.approve(address(escrow), 97 * TOKEN_1);
        escrow.create_lock(97 * TOKEN_1, 4 * 365 * 86400);
        vm.roll(block.number + 1);

        // owner2 owns less than quorum, 3%
        vm.startPrank(address(owner2));
        STERLING.approve(address(escrow), 3 * TOKEN_1);
        ...
        governor = new SterlingGovernor(escrow);
    ...
    function testVeSterlingMergesAutoDelegates() public {
